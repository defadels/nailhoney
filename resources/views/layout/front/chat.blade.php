...
<div class="modal fade" id="chat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <!-- fixed button -->
    <section class="fixed-bottom p-4">
       ...
       <a href="https://api.whatsapp.com/send?phone=6281370721854<&text=Halo, apakah ini dengan admin Madu Al-Hafizh?" class="btn btn-success p-3 rounded-circle float-right" target="_blank">
