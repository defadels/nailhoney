...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
					...
					<!--end breadcrumb-->
					{!! Form::open(['route' => 'admin.penjualan.masuk.store', 'method' => 'PUT']) !!}
								...
								<div class="card-body">
									...
									<hr/>
										<div class="form-body">
											...
											<div class="form-group row">
												{!! Form::label('total_belanja', 'Total Belanja', ['class' => 'col-sm-3 col-form-label']) !!}
												<div class="col-sm-9">
													{!! Form::number('total_belanja', old('total_belanja'),['class' => 'form-control']) !!}
												</div>
											</div>
